 ...
 */
function openidrp_profile_modules() {
  return array(
    'color', 
    'comment', 
    'help', 
 ...
 */
function openidrp_profile_details() {
  return array(
 ...
 *   task list.
 */
function openidrp_profile_task_list() {
  return array(
 ...
 */
function openidrp_profile_tasks(&$task, $url) {
 ...
 */
function _openidrp_system_theme_data() {
  global $profile;
  $profile = 'openidrp';
